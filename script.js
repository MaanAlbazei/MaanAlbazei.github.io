...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.project-card, .skill-item, .timeline-item, .about-text, .about-stats, .cert-card, .language-item');
...
// Initialize hero title when page loads
...
console.log(`
 ...
 GitHub: github.com/MaanAlbazei
 LinkedIn: linkedin.com/in/maanalbazei
